...
public class LC_001_1_VO {
	...
	private String m_index;		//작성자 멤버 번호
	private String lc_title;	//게시글 제목
	private String lc_type;		//게시글 유형(자전거, 육상)
	...
	private String lc_date;		//작성 날짜
	private int lc_good;		//좋아요 수
	private int lc_see;			//조회수
	private String lc_record;	//평균 기록
	private String lc_address;	//상세주소
	private String lc_xy_arr;	//좌표 뭉치
